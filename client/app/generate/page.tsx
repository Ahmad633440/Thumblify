...
const handleGenerate = async () => {
  ...
  // Temporary mock thumbnail for testing (replace with actual API call later)
  setTimeout(() => {
    const mockThumbnail: IThumbnail = {
      id: 'temp-' + Date.now(),
      title: title || 'Sample Thumbnail',
      image_url: 'https://picsum.photos/800/450?random=' + Date.now(), // Temporary random image
      style: style,
      aspect_ratio: aspectRatio,
      color_scheme: colorSchemeId,
      created_at: new Date().toISOString()
    }
    setGeneratedThumbnail(mockThumbnail)
    setLoading(false)
